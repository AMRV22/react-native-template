...
export const themes = {
  light: vars({
    '--color-primary-default': '#2741a6',
    '--color-primary-light': '#4680eb',
    '--color-secondary-default': '#69a2f1',
    '--color-secondary-light': '#9ac2f6',
    '--color-tertiary-default': '#3f7aa6',
    '--color-tertiary-light': '#67a0c9',
